/* @ts-self-types="./statify_string_to_word.d.ts" */
 ...
 * @returns {any}
 */
export function process_text_data(js_data, js_config) {
    const ret = wasm.process_text_data(js_data, js_config);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./statify_string_to_word_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('statify_string_to_word_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
