...
// Komponen utama konten TwoRelatedSamples yang agnostik terhadap container
const TwoRelatedSamplesContent: FC<BaseModalProps> = ({ onClose, containerType = "dialog" }) => {
        ...
        <>
            ...
            <div className="px-6 py-3 border-t border-border flex items-center justify-between bg-secondary flex-shrink-0">
                ...
                <div>
                    ...
                    <Button
                        id="two-related-samples-ok-button"
                        onClick={runAnalysis}
                        disabled={
                            isCalculating ||
                            !areAllPairsValid() ||
...
const TwoRelatedSamples: FC<BaseModalProps> = ({ onClose, containerType = "dialog", ...props }) => {
    if (containerType === "sidebar") {
        return (
            <div className="h-full flex flex-col overflow-hidden bg-popover text-popover-foreground">
                <div className="flex-grow flex flex-col overflow-hidden">
                    <TwoRelatedSamplesContent onClose={onClose} containerType={containerType} {...props} />
                </div>
            </div>
        );
    }
    ...
    return (
        <DialogContent className="max-w-[600px] p-0 bg-popover text-popover-foreground border border-border shadow-md rounded-md flex flex-col max-h-[85vh]">
            <DialogHeader className="px-6 py-4 border-b border-border flex-shrink-0">
                <DialogTitle className="text-[22px] font-semibold">Two Related Samples</DialogTitle>
            </DialogHeader>
...
export default TwoRelatedSamples;
export { TwoRelatedSamplesContent };