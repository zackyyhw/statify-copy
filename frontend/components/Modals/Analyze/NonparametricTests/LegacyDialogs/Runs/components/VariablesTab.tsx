...
const VariablesTab: FC<VariablesTabProps> = ({
    ...
    return (
        <div className="space-y-2">
            ...
            <div id="runs-available-variables" className="absolute top-0 left-0 w-[48%] h-full pointer-events-none rounded-md">
                <ActiveElementHighlight active={tourActive && currentStep === tourSteps.findIndex(step => step.targetId === 'runs-available-variables')} />
            </div>
            <div id="runs-test-variables" className="absolute top-0 right-0 w-[48%] h-full pointer-events-none rounded-md">
                <ActiveElementHighlight active={tourActive && currentStep === tourSteps.findIndex(step => step.targetId === 'runs-test-variables')} />
            </div>
        </div>
    );
};
