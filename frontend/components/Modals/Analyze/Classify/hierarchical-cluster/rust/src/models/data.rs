...
pub struct AnalysisData {
    pub cluster_data: Vec<Vec<DataRecord>>,
    pub label_data: Vec<Vec<DataRecord>>,
    pub cluster_data_defs: Vec<Vec<VariableDefinition>>,
    pub label_data_defs: Vec<Vec<VariableDefinition>>,
}
