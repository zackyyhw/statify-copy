...
interface NonautocorrelationTestProps {
  data: string;
}
...
const NonautocorrelationTest: React.FC<NonautocorrelationTestProps> = ({ data }) => {
  try {
    ...
    if (!result || typeof result !== 'object' || !('durbinWatsonStatistic' in result)) {
      console.error('Invalid nonautocorrelation test data:', result);
      return (
        <Alert variant="destructive">
          <AlertTitle>Error</AlertTitle>
          <AlertDescription>
            Invalid nonautocorrelation test data. Please try running the test again.
          </AlertDescription>
        </Alert>
      );
    }
      ...
      <div className="space-y-4">
        ...
        <div className="text-xs text-muted-foreground mt-2">
          <div className="flex items-center">
            ...
            <span>
              The Durbin-Watson test checks for nonautocorrelation in regression residuals.
    ...
    console.error('Error rendering nonautocorrelation test:', error);
    return (
      <Alert variant="destructive">
        <AlertTitle>Error</AlertTitle>
        <AlertDescription>
          Failed to parse nonautocorrelation test results.
...
export default NonautocorrelationTest; 