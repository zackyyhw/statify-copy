...
export class DiscriminantAnalysis {
     ...
     */
    get_all_log() {
        const ret = wasm.discriminantanalysis_get_all_log(this.__wbg_ptr);
        if (ret[2]) {
...
if (Symbol.dispose) DiscriminantAnalysis.prototype[Symbol.dispose] = DiscriminantAnalysis.prototype.free;
