...
export class KNNAnalysis {
     ...
     */
    get_all_log() {
        const ret = wasm.knnanalysis_get_all_log(this.__wbg_ptr);
        if (ret[2]) {
    ...
    get_formatted_results() {
        const ret = wasm.knnanalysis_get_formatted_results(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
if (Symbol.dispose) KNNAnalysis.prototype[Symbol.dispose] = KNNAnalysis.prototype.free;
