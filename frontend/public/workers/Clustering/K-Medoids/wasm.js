...
export class KMedoidsCluster {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        KMedoidsClusterFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_kmedoidscluster_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.kmedoidscluster_new();
        this.__wbg_ptr = ret >>> 0;
        KMedoidsClusterFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
 ...
 * @returns {any}
 */
export function run_k_medoids(input_value) {
    const ret = wasm.run_k_medoids(input_value);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function run_k_medoids_range(input_value) {
    const ret = wasm.run_k_medoids_range(input_value);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
export function test_connection() {
    ...
    let deferred1_1;
    try {
        const ret = wasm.test_connection();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_set_251f9ffe54430752: function(arg0, arg1, arg2) {
            arg0.set(arg1, arg2 >>> 0);
        },
        __wbg_set_282384002438957f: function(arg0, arg1, arg2) {
            arg0[arg1 >>> 0] = arg2;
        },
        __wbg_set_3dd16978ef901a0f: function(arg0, arg1, arg2) {
            arg0.set(arg1, arg2 >>> 0);
        },
...
const KMedoidsClusterFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_kmedoidscluster_free(ptr >>> 0, 1));
