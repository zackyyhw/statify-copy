/* @ts-self-types="./statify_ordinal.d.ts" */

/**
 * @param {any} input
 * @returns {any}
 */
export function plum_fit(input) {
    const ret = wasm.plum_fit(input);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function plum_validate(input) {
    const ret = wasm.plum_validate(input);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {string}
 */
export function plum_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.plum_version();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('statify_ordinal_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
