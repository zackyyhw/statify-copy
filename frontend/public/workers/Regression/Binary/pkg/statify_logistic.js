 ...
 * @returns {any}
 */
export function calculate_binary_logistic(data_x, rows, cols, data_y, config_json, feature_names_json) {
    const ptr0 = passArrayF64ToWasm0(data_x, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    ...
    const ptr3 = passStringToWasm0(feature_names_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.calculate_binary_logistic(ptr0, len0, rows, cols, ptr1, len1, ptr2, len2, ptr3, len3);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function calculate_box_tidwell(data_x, rows, cols, data_y, config_json) {
    const ptr0 = passArrayF64ToWasm0(data_x, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayF64ToWasm0(data_y, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.calculate_box_tidwell(ptr0, len0, rows, cols, ptr1, len1, ptr2, len2);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('statify_logistic_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
